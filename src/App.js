...
export default function App() {
  ...
  async function handleLikeRepository(id) {
    ...
    const newRepositories = repositories.filter(repo => repo !== undefined)
    const likedRepoIndex = newRepositories.findIndex(repo => repo.id === likedRepo.id)

    newRepositories[likedRepoIndex] = likedRepo
